...
insert into continent (continent_name, population) values (1, 'Asia', 4641054775);
insert into continent (continent_name, population) values (2, 'Africa', 1340598147);
insert into continent (continent_name, population) values (3, 'Europe', 747636026);
insert into continent (continent_name, population) values (4, 'North America', 592072212);
insert into continent (continent_name, population) values (5, 'South America', 430759766);
insert into continent (continent_name, population) values (6, 'Australia', 43111704);
insert into continent (continent_name, population) values (7, 'Antarctica', 0);
